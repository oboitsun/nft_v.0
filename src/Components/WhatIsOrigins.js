...
export default class WhatIsOrigins extends Component {
  render() {
    return (
      <section className='flex justify-center  items-center text-white font-mont pb-10 md:pb-16 lg:pb-24  xl:pb-36 2xl:pb-44 md:px-10'>
        <div className=' sm:w-2/3 lg:w-1/2  flex-shrink flex flex-col items-start'>
          <h3 className='text-2xl md:text-4xl  2xl:text-6xl xl:pb-4 font-extrabold text-turq uppercase leading-snug'>
            What is origins
          </h3>
          <p className='text-xl md:text-2xl lg:text-3xl 2xl:text-5xl flex flex-col text-left whitespace-pre-line leading-tight'>
            <span>
              A new type of
        ...
        <div className='hidden sm:flex flex-shrink sm:w-1/3 lg:w-1/4 2xl:w-1/5 '>
