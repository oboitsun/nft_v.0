...
export default class WhatIsNFT extends Component {
  render() {
    return (
      <section className='font-mont text-white relative py-20 pb-44 '>
        <div className='absolute opacity-30 lg:opacity-60 2xl:opacity-100   md:w-40 md:h-40  2xl:w-52 2xl:h-52  lg:top-10% 2xl:top-0  lg:left-10% z-0'>
          <svg className='w-full' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 201.12 201.12'>
            <defs>
        ...
        <div className='flex flex-col items-center z-2'>
          ...
          <div className=' flex flex-col text-2xl md:text-4xl lg:text-5xl 2xl:text-5xl italic z-2'>
            <span className='z-2'>
