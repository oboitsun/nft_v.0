...
export default function WhatIsNFTUser() {
  ...
  return (
    <section className='font-mont text-white relative py-20 pb-44 '>
      <div className='absolute opacity-50 lg:opacity-80 2xl:opacity-100   md:w-40 md:h-40  2xl:w-52 2xl:h-52  lg:top-10% 2xl:top-0  lg:left-10% z-0'>
        <motion.svg
          animate={controls}
          initial='hidden'
          variants={move2}
